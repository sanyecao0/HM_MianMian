    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            ...
            <div class="pull-left info">
                <p> ${empty sessionScope.user.username?"管理员":sessionScope.user.username}</p>
                <a href="#">${empty sessionScope.user.dept.name?"集团总部":sessionScope.user.dept.name}</a>
            </div>
        </div>
...
<%-- <li class="treeview">
     ...
     <ul class="treeview-menu">
         <li id="company-manager">
             <a href="${ctx}/system/company?operation=list" onclick="setSidebarActive(this)" target="iframe">
