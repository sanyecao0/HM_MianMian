...
<div id="frameContent" class="content-wrapper" style="margin-left:0px;">
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <form id="urform" action="${ctx}/system/user?operation=updateUserAndRoles" method="post">
                    <input type="hidden" name="userId" value="${user.id}"/>
                    <div class="textbox" id="centerTextbox">
                            <div style="text-align:left">
                                <c:forEach items="${roleList}" var="role" varStatus="vs">
                                     <span style="padding:3px;margin-right:30px;width: 160px;display: inline-block">
                                         <input type="checkbox" name="roleIds" value="${role.id}" ${roleIds.contains(role.id)?"checked":""}/>${role.name}
                                     </span>
                                </c:forEach>
                            </div>
                        </div>
