...
<head>
    ...
    <script type="text/javascript" src="${ctx}/js/axios-0.18.0.js"></script>
</head>
...
<div id="frameContent" class="content-wrapper" style="margin-left:0px;height: 1200px" >
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="${pageContext.request.contextPath}/system/role?operation=list"><i class="fa fa-dashboard"></i> 角色管理</a></li>
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="table-box">
                    <!-- 树菜单 /-->
                    <form name="icform" id="icform" method="post" action="${ctx}/system/role?operation=updateRoleAndModules">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        //1 页面加载完成，发送异步请求，获取模块信息(树形菜单需要的数据)
        axios.get("${pageContext.request.contextPath}/system/module?operation=findModulesByRoleId&roleId=${role.id}").then(function (resp) {
            zNodes=resp.data; //获取数据
