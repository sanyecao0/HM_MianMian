        ...
        <div class="box-body">
            ...
            <div class="table-box">
                ...
                <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                    ...
                    <tbody>
                    <c:forEach items="${page.list}" var="dept" varStatus="vs">
                        <tr>
                            <td>${vs.count}</td>
                            <td>${dept.name}</td>
                            <td>${dept.parent.name }</td>
                            <td>${dept.state==0?'未启用':'使用中'}</td>
                            <td><a href="${ctx}/system/dept?operation=toEdit.do&id=${dept.id}">${dept.name }</a></td>
                            <th class="text-center">
                                ...
                                <button type="button" class="btn bg-olive btn-xs" onclick='deleteById("${dept.id}")'>删除</button>
                            </th>
                        </tr>
                    </c:forEach>
                    </tbody>
