...
<div id="frameContent" class="content-wrapper" style="margin-left:0px;">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="${pageContext.request.contextPath}/system/user?operation=list"><i class="fa fa-dashboard"></i> 用户管理</a></li>
        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="${ctx}/system/user?operation=edit" method="post">
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="密码" name="password" value="${user.password}" readonly>
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <select class="form-control" name="deptId">
                            ...
                            <c:forEach items="${deptList}" var="item">
                                <option ${user.deptId == item.id ?'selected':''} value="${item.id}">${item.name}</option>
                            </c:forEach>
                        </select>
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <div class="input-group date">
                            ...
                            <input type="text" placeholder="出生年月" class="form-control pull-right" name="birthday"
                                   value="${user.birthday}" id="datepicker1" readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <div class="input-group date">
                            ...
                            <input type="text" placeholder="入职时间"  name="joinDate" class="form-control pull-right"
                                   value="${user.joinDate}" id="2" readonly>
                        </div>
                    </div>
                </div>
            </form>
